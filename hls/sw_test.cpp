...
int test_conv1() {
    ...
    conv2d(conv1_input, conv1_w, conv1_bias, output, batch_size, input_shape_ch, input_shape_n, input_shape_m, conv1_shape_ch, conv1_k);
...
int test_batchnorm1() {
    ...
    float output[1*3*26*26];
    batchnorm2d(conv1_output, output, batch_size, conv1_shape_ch, conv1_shape_n, conv1_shape_m, batchnorm1_means, batchnorm1_denoms, batchnorm1_gammas, batchnorm1_betas);
...
int test_relu1() {
    ...
    float output[1*3*26*26];
    relu(batchnorm1_output, output, batch_size * batchnorm1_shape_ch * batchnorm1_shape_n * batchnorm1_shape_m);
...
int test_maxpool1() {
    ...
    maxpool2d(relu1_output, output, batch_size, relu1_shape_ch, relu1_shape_n, relu1_shape_m, maxpool1_k);
...
int test_conv2() {
    ...
    conv2d(maxpool1_output, conv2_w, conv2_bias, output, batch_size, maxpool1_shape_ch, maxpool1_shape_n, maxpool1_shape_m, conv2_shape_ch, conv2_k);
...
int test_batchnorm2() {
    ...
    float output[1*5*9*9];
    batchnorm2d(conv2_output, output, batch_size, conv2_shape_ch, conv2_shape_n, conv2_shape_m, batchnorm2_means, batchnorm2_denoms, batchnorm2_gammas, batchnorm2_betas);
...
int test_relu2() {
    ...
    float output[1*5*9*9];
    relu(batchnorm2_output, output, batch_size * batchnorm2_shape_ch * batchnorm2_shape_n * batchnorm2_shape_m);
...
int test_maxpool2() {
    ...
    maxpool2d(relu2_output, output, batch_size, relu2_shape_ch, relu2_shape_n, relu2_shape_m, maxpool2_k);
...
int test_linear() {
    ...
    float output[1*2];
    linear(maxpool2_output, linear1_weights, linear1_bias, output, batch_size, 1, maxpool2_shape_ch * maxpool2_shape_n * maxpool2_shape_m, linear1_shape_m);
